...
// items-Farm 
const itemsFarm =[
    {name: "house-1", address: "item-house-1"},
    {name: "house-2", address: "item-house-2"},
    {name: "house-3", address: "item-house-3"},
    {name: "house-4", address: "item-house-4"},
    {name: "house-5", address: "item-house-5"},
    {name: "house-6", address: "item-house-6"},
    {name: "house-7", address: "item-house-7"}
]

// items-Account 
const itemsAccount =[
    {name: "tk-1", address: "item-account-1"},
    {name: "tk-2", address: "item-account-2"},
    {name: "tk-3", address: "item-account-3"},
    {name: "tk-4", address: "item-account-4"},
    {name: "tk-5", address: "item-account-5"},
    {name: "tk-6", address: "item-account-6"},
    {name: "tk-7", address: "item-account-7"}
]
...
export {ListAdmin, ListFarm, ListAccount};